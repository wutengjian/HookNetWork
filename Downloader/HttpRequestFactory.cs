...
namespace Downloader
{
    ...
    public class HttpRequestFactory
    {
        ...
        /// 是否跟踪cookies
        /// </summary>
        /// <param name="_isTrackCookies"></param>
        public HttpRequestFactory(bool _isTrackCookies = false)
        {
            this.isTrackCookies = _isTrackCookies;
        }
        ...
        {
            return UrlEncode(item.Trim('\t').Trim(), Encoding.GetEncoding("gb2312"));
        }
